...
var _TuringMaschine = __webpack_require__(40);

var _TuringMaschine2 = _interopRequireDefault(_TuringMaschine);

function _interopRequireDefault(obj) { return obj && obj.__esModule ? obj : { default: obj }; }

var tm = global.tm = new _TuringMaschine2.default();
tm.setStates(["a", "b", "end"]);
tm.setEndState("end");
tm.setStartState("a");

tm.setInstruction("a", "0", new _TuringMaschine.Instruction("a", "0", "R"));
tm.setInstruction("a", "1", new _TuringMaschine.Instruction("a", "1", "R"));
tm.setInstruction("a", "B", new _TuringMaschine.Instruction("b", "B", "L"));

tm.setInstruction("b", "0", new _TuringMaschine.Instruction("end", "0", "R"));
tm.setInstruction("b", "1", new _TuringMaschine.Instruction("b", "1", "L"));
tm.setInstruction("b", "B", new _TuringMaschine.Instruction("a", "B", "R"));

tm.checkInstructionTable();

tm.resetTo("110".split(""));

global.Instruction = _TuringMaschine.Instruction;
...
var TuringMaschine = function () {
    function TuringMaschine() {
        (0, _classCallCheck3.default)(this, TuringMaschine);
    ...
    (0, _createClass3.default)(TuringMaschine, [{
        key: "setStates",
        value: function setStates(states) {
            this.allStates = new _set2.default(states);
        }
    }, {
        key: "addState",
        ...
        key: "setStartState",
        value: function setStartState(startState) {
            if (!this.allStates) {
                throw "states not set";
            }
        ...
        key: "setEndState",
        value: function setEndState(endState) {
            if (!this.allStates) {
                throw "states not set";
            }
        ...
        key: "setInstructionTable",
        value: function setInstructionTable(instructionTable) {
            this.instructionTable = (0, _extends3.default)({}, this.instructionTable, instructionTable);
        }
    }, {
        key: "setInstruction",
        value: function setInstruction(state, symbol, instruction) {
        ...
        key: "getInstructionAt",
        value: function getInstructionAt(state, symbol) {
            return this.instructionTable[state][symbol];
        }
    }, {
        key: "checkInstructionTable",
        value: function checkInstructionTable() {
            var allSet = true;
        ...
        value: function step() {
            ...
            var currInstr = this.getInstructionAt(this.stateRegister, this.tape[this.headPosition]);
        ...
        key: "runInstruction",
        value: function runInstruction(instruction) {
        ...
        key: "printCurrentState",
        value: function printCurrentState() {
            console.table({
                tape: (0, _extends3.default)({}, this.tape),
                position: (0, _defineProperty3.default)({}, this.headPosition, "↑")
            });
        }
    }]);
...
exports.default = TuringMaschine;

var Instruction = exports.Instruction = function () {
    function Instruction(nextState, writeSymbol, moveDirection) {
